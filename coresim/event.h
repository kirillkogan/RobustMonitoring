...
#define FLOW_SEND_PENDING_DATA 2
#define PACKET_ARRIVAL 3
#define QUEUE_PROCESSING 4
#define FLOW_FINISHED 5
#define FLOW_CREATION_EVENT 6
#define LOGGING 7
...
class FlowSendPendingData : public Event {
public:
    FlowSendPendingData(double time, Flow *flow);
    ~FlowSendPendingData();
    void process_event();
    Flow *flow;
};
